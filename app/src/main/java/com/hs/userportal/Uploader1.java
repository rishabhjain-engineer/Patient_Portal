...
public class Uploader1 {
    ...
    public Uploader1(Context context, AmazonS3Client s3Client, String s3bucketName, String s3key, File file, String path,String filename) {

        this.s3Client = s3Client;
//		this.s3key = s3key+".jpg";
        this.s3key = path+UUID.randomUUID().toString()+"/"+filename;
