...
public class LocationClass extends ActionBarActivity
    ...
    private ArrayAdapter<String> adapter_multi;
    private static Integer position;
    private Menu menu1;
    private int firsttimecheck;
    private View v;
    private Button popular_pkgs;
    ...
    private ListView lvLab, lvTest, lvTestsdefault;
    private String[] parts;
    private int count = 0;
    private Double currentlat, currentlon;
    private String centreName, areaName, TieUpWithLab;
    private JSONArray gpsarray, testArray, testLablistArray;
    ...
    private List<String> centerID = new ArrayList<String>();
    private Button bGPS, bArea;
    private static final String name = "nameKey";
    private static final String pass = "passwordKey";
    private EditText etGPS, etArea, etSearch, etSearchtxt_action;
    private AutoCompleteTextView etSearchTests;
    private AlertDialog alert;
    private ProgressDialog progressDialog;
    private String fnln, id;
    private JsonObjectRequest getRequest;
    private Boolean isTf = false, isHome = false, isOur = false, isOpen = false, isDiscount = false;
    private int filteredlist, seekProgress = 3;
    private SharedPreferences sharedpreferences;
    private SharedPreferences sharedPreferences;
    private LinearLayout bottomBarMap, botm_defaultcheck_prc;
    private float distancemeter;
    private static final int PICK_FROM_CAMERA = 1;
    private static final int PICK_FROM_GALLERY = 2;
    private String rating, discount;
    private ArrayAdapter<String> testListAdapter;
    private Double defaultLat, defaultLong;
    private boolean hasParking = false, hasDrinking = false, hasWashroom = false, hasSeating = false, hasHomeColl = false, openTwentFour = false, cloudchowkClient = false, openNow = false;
    private boolean filterChanged = false;
    private String currentTime, testAvailability;
    private RadioButton rLocation, rArea;
    private Button upload_btn, upload_btn_laytest;
    private SegmentedGroup segmented, segmentLabTest;
    private ConnectionDetector con;
    private Float filterdistancemeter;
    private RelativeLayout lTests;
    private RelativeLayout lLabs;
    private static final String LOG_TAG = "ExampleApp";
    private TagView tagView;
    private int segmentedControl = 0;
    private static final String PLACES_API_BASE = "https://maps.googleapis.com/maps/api/place";
    private static final String TYPE_AUTOCOMPLETE = "/autocomplete";
    private static final String OUT_JSON = "/json";
    private static final String API_KEY = "AIzaSyD0NIjG9eekYS6x58yrvpGi9x11STX_BOM";
    private TextView tvNoTest, message_err;
    private LinearLayout ratingAll, ratingOnePlus, ratingTwoPlus, ratingThreePlus, ratingFourPlus;
    private float myRating = 0;
    private ArrayList<SortList> copyFilterSortList = new ArrayList<SortList>();
    private CheckBox cbDiscount;
    private CheckBox cbOpenNow;
    private CheckBox cbOurClient;
    private CheckBox cbHomeColl;
    private CheckBox cbTwentyFour;
  //  private UiLifecycleHelper uiHelper;
    private static final String MyPREFERENCES = "MyPrefs";
    private String userID, fbdata, uName, passw;
    private static String init = "https://patient.cloudchowk.com:8081/WebServices/LabService.asmx";
    private int fberror = 0, ratingView;
    private Uri Imguri;
    private int default_testcheck = 0; // for first time defaulttestlist
   ...
   /* String[] default_listvalues = {"Liver Function Test", "Kidney Function Test", "Thyroid Profile", "Lipid Profile",
    ...
    private String[] default_listvalues = {"Complete Blood Count (CBC)", "Kidney Function Test", "Lipid Profile", "Liver Function Test", "Thyroid Profile", "Vitamin D 25 Hydroxy"};
